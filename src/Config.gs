const CONFIG = {
  ...
  LEAGUES: {
    ...
    CATALOG: {
      WC2026:       { id: 1,   season: 2026, competition_season_id: 'WC2026',            competition_id: 'FIFA_WORLD_CUP',          name: 'Mundial FIFA 2026',          sport_key: 'soccer_fifa_world_cup',             country: 'World',     region: 'Global',        type: 'cup',    tier: 1, home_adv: 1.0,  target_status: 'BETTABLE',      liquidity_tier: 'MEDIUM', format: 'GROUP_THEN_KNOCKOUT', stage_rules: { group_stage_end: '2026-06-27', knockout_start: '2026-06-28' } },
